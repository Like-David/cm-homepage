...
const FAQ_DATA = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                id: 's2',
                question: '기술 지원 운영 시간이 어떻게 되나요?',
                answers: [
                    '평일 오전 9시부터 오후 6시까지 운영하며, 점심시간(12시~13시)과 주말·공휴일은 제외됩니다.',
                    '긴급 장애의 경우 기술지원 핫라인(0505-998-0888)으로 연락 주시면 담당자가 안내해 드립니다.',
                ],
            },
            {
                id: 's3',
                ...
                answers: [
                    '먼저 대표번호(02-6949-4170)로 연락 주시면 담당자가 문의 내용을 확인합니다.',
                    '원격 지원이 필요한 경우 담당자 안내에 따라 988.co.kr에 접속 후 6자리 인증번호를 입력하시면 됩니다.',
                ],
            },
            {
                id: 's4',
                question: '유지보수 계약은 어떻게 진행하나요?',
                answers: [
                    '제품 도입 후 영업 담당자를 통해 유지보수 계약을 별도로 체결할 수 있습니다.',
                    '계약 내용에 따라 기술 지원 범위 및 응대 시간이 달라질 수 있으니 자세한 사항은 담당자에게 문의해 주세요.',
                ],
            },
        ],
    },
